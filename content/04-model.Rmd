...
在上述研究的基础上，本文希望进一步探究对于南向政策和新南向政策的核心实施国家与非核心实施国家的政策干预效应，以及政策对两者的干预效应是否存在差异。对于新南向政策的核心，本文参考2016年9月19日台湾当局“外交部长”李大维参加相关会议论坛提出的国家进行划分。对于南向政策时期的研究，本文将GSP1.1所涉及国家设置为“核心国家”。除上述定义的“核心国家”，受政策干预的其他国家作为“非核心国家”。模型设置如下：

\begin{equation}
Perc_{it} = \beta \cdot Treat_{it} \cdot G_{i} + \alpha \cdot G_{i} + \gamma \cdot Z + \lambda_{i} + \mu_{t} + \epsilon_{it}(\#eq:twdidheter)
\end{equation}

模型\@ref(eq:twdidheter)使用异质性分析的思路，将政策干预个体分为核心国家与非核心国家，如果个体$i$属于设定的核心国家，则$G_{i}$取1，否则取0。通过观察回归系数$\beta$的显著性可得出政策干预核心国家的实施效果。若$\beta$在95%的置信区间上显著异于0，则说明政策干预对核心国家是有效的。除此之外，我们使用Wald检验来判断是否核心国家与非核心国家的回归系数$\beta$的差值在统计上显著异于0。如果显著异于0则认为政策对核心国家与非核心国家的干预存在显著性差异。
